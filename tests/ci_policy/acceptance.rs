...
#[test]
fn ci_policy_accepts_cross_platform_native_workflow() -> anyhow::Result<()> {
    let workflow = r#"
name: Rust CI
...
"#;
    ...
    assert_eq!(report.status, "native-ci");
    assert_eq!(report.missing_os, Vec::<String>::new());
    assert_eq!(report.missing_commands, Vec::<String>::new());
