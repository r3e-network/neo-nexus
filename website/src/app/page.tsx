    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section id="products" className="py-24 md:py-32">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-[#111111] border border-[#222222] hover:border-[#00E599]/50 rounded-2xl p-8 transition-all group">
            ...
            {/* Feature 2 */}
            <div className="bg-[#111111] border border-[#222222] hover:border-blue-500/50 rounded-2xl p-8 transition-all group relative overflow-hidden">
            ...
            {/* Feature 3 */}
            <div className="bg-[#111111] border border-[#222222] hover:border-purple-500/50 rounded-2xl p-8 transition-all group">
      ...
      <section className="py-24 md:py-32 bg-[#050505] border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#111111] border border-[#333333] text-sm text-[#00E599] font-medium mb-6">
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#111111] border border-[#333333] rounded-2xl p-6 shadow-2xl">
...
const node = new rpc.RPCClient(
  'https://mainnet.neonexus.io/v1/your-api-key'
);
