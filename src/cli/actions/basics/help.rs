...
const OPTION_LINES: &[&str] = &[
    ...
    "  --export-backup              Export an encrypted full workspace backup archive",
    "  --export-backup-json         Export backup and print manifest as JSON",
    "  --import-backup              Import a previously exported workspace backup archive",
    "  --import-backup-json         Import backup and print result as JSON",
    "  --validate-backup            Inspect and validate a backup archive without importing",
    "  --validate-backup-json       Validate backup archive and print result as JSON",
