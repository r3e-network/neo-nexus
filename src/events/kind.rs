...
define_event_kinds! {
    ...
    SignerKeyCreated => "signer-key-created",
    SignerKeyStateChanged => "signer-key-state-changed",
    SignerKeyDeleted => "signer-key-deleted",
    SignerCallerCreated => "signer-caller-created",
    SignerCallerRotated => "signer-caller-rotated",
    SignerCallerStateChanged => "signer-caller-state-changed",
    SignerCallerDeleted => "signer-caller-deleted",
    SignerPolicyUpdated => "signer-policy-updated",
    SignerHealthChanged => "signer-health-changed",
    SignerRequestFailed => "signer-request-failed",
