...
impl NeoNexusApp {
    pub(in crate::app::views::shell::inventory) fn render_inventory_filter(
        ...
        // No "Status" label: the chips name themselves, and the extra label was
        // what pushed this row past the inventory panel's design width, forcing
        // the panel to its maximum and still clipping the last chip.
        chip_pill(ui, |ui| {
