                ...
                endpoints.slice(0, 3).map((ep) => (
                  <div key={ep.id} className="p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:bg-[var(--color-dark-panel)]/30 transition-colors">
                    ...
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      <div className="bg-[var(--color-dark-panel)] border border-[var(--color-dark-border)] px-3 py-1.5 rounded flex items-center gap-2 max-w-[200px] overflow-hidden">
                      ...
                      <button onClick={() => copyToClipboard(ep.url)} className="p-1.5 text-gray-500 hover:text-white bg-[var(--color-dark-panel)] border border-[var(--color-dark-border)] rounded transition-colors" title="Copy URL">
