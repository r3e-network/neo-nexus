...
4. **Native Web3 Integration:** The platform operates entirely on-chain. Authentication is driven by NeoLine wallet signatures (SIWN) and payments are verified directly against the Neo N3 blockchain (GAS).
...
- **AWS Account:** For KMS (Key Management Service) secret custody.
